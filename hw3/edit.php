	...
	<img src="./img/write.png" class="img" alt="一張圖片">
      ...
      <form action="edit.php" method="post" >
          ...
          if (isset($_POST['submit'])) {
            	...
            	//$sql = "UPDATE post SET title = '$title', content= '$text' WHERE id= '$id' ";
							$sql = "UPDATE post SET title = '$title', content = '$content' WHERE id = '$id' ";
							//$sql = "INSERT INTO post (username,title, content) VALUES ('$who','$title','$content') ";
					  	$result = mysqli_query($conn, $sql);
							if (!$result) {
							    die('資料更新失敗：' . mysqli_error($connection));
							}
		      ...
		      header("Location:" . $goto);
				...
				?>
				序號<h3><?php $_SESSION["which_edit"] = $_GET['id']; $id = $_SESSION["which_edit"]; echo $id; ?></h3>
				<br>
				<br>
